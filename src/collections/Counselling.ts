...
export const Counselling: CollectionConfig = {
  ...
  admin: {
    useAsTitle: 'title',
    group: 'Content',
    ...hiddenForCollection('counselling'),
  },
  versions: {
    drafts: true,
  },
  ...
  access: {
    read: publishedOrAdmin('counselling'),
    create: can('counselling').create,
    update: can('counselling').update,
    delete: can('counselling').delete,
  },
  fields: [
    {
      name: 'title',
