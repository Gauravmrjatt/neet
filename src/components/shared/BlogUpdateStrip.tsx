...
interface BlogUpdateStripProps {
  text?: string | null
  link?: string | null
  isEnabled?: boolean | null
}

const DEFAULT_TEXT = '📢  नवीनतम JOSAA अपडेट्स & गाइड्स के लिए हमारा ब्लॉग देखें  |  Visit our Blog for Latest NEET & JOSAA Updates'

export function BlogUpdateStrip({ text, link, isEnabled }: BlogUpdateStripProps) {
  if (isEnabled === false) return null

  const displayText = text || DEFAULT_TEXT
  const displayLink = link || '/blog'
